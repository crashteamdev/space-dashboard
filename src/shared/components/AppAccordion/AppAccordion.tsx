...
export const AppAccordion: React.FC<Props> = ({
  ...
  return (
    <div className={clsx("bg-[#fff] pt-[20px] pb-[15px] rounded-lg shadow-[unset]", className, {
      "": open
    })}>
      <button
        className={clsx(
          "flex justify-between items-start w-full text-start px-6 py-3 max-md:p-4 text-[#2A3547]",
          headerClassName,
          {
            "": open
          }
      ...
      >
        ...
        {!open ? <AppIcon type="plusIcon" color="black" /> : <AppIcon type="minusIcon" color="black" /> }
