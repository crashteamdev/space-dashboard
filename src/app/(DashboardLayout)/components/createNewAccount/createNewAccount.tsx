...
import { createNewAccount } from "@/store/apps/account/AccountSlice";
...
const CreateNewAccount = ({ open, setOpen }: any) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      console.log(1)
      createNewAccount(auth.currentUser.accessToken, company.activeCompany, values.login, values.password)
    },
  });
